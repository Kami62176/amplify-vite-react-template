...
export default function App() {
  ...
  return (
    <>
      <AppBar position={"static"} sx={{margin: "10px", padding: 1, borderRadius: 2}}>
        <Button variant="contained" onClick={signOut} sx={{width: 100, backgroundColor: "blueviolet"}}>Sign out</Button>
      </AppBar>
      <Container >
